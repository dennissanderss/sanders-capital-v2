...
const HISTORICAL: {
  ...
  // ═══ 2025-05 ═══ Fed cut 25bp to 4.08, ECB cut to 2.25%, BoE cut to 4.25%
  { snapshot_date: '2025-05-01', currency: 'USD', rate: 4.08, target: 3.83, bias: 'voorzichtig verruimend', bank: 'Federal Reserve (Fed)' },
  { snapshot_date: '2025-05-01', currency: 'EUR', rate: 2.25, target: 2.00, bias: 'voorzichtig verruimend', bank: 'ECB' },
  { snapshot_date: '2025-05-01', currency: 'GBP', rate: 4.25, target: 4.00, bias: 'voorzichtig verruimend', bank: 'Bank of England (BoE)' },
  { snapshot_date: '2025-05-01', currency: 'JPY', rate: 0.50, target: 0.75, bias: 'voorzichtig verkrappend', bank: 'Bank of Japan (BoJ)' },
  { snapshot_date: '2025-05-01', currency: 'CHF', rate: 0.25, target: 0.00, bias: 'afwachtend', bank: 'SNB' },
  { snapshot_date: '2025-05-01', currency: 'AUD', rate: 3.85, target: 3.60, bias: 'voorzichtig verruimend', bank: 'RBA' },
  { snapshot_date: '2025-05-01', currency: 'CAD', rate: 2.75, target: 2.50, bias: 'afwachtend', bank: 'BoC' },
  { snapshot_date: '2025-05-01', currency: 'NZD', rate: 3.25, target: 3.00, bias: 'voorzichtig verruimend', bank: 'RBNZ' },
  // ═══ 2025-06 ═══ SNB cut to 0.00%, ECB held, most on hold
  { snapshot_date: '2025-06-01', currency: 'USD', rate: 4.08, target: 3.83, bias: 'afwachtend', bank: 'Federal Reserve (Fed)' },
  { snapshot_date: '2025-06-01', currency: 'EUR', rate: 2.25, target: 2.00, bias: 'afwachtend', bank: 'ECB' },
  { snapshot_date: '2025-06-01', currency: 'GBP', rate: 4.25, target: 4.00, bias: 'voorzichtig verruimend', bank: 'Bank of England (BoE)' },
  { snapshot_date: '2025-06-01', currency: 'JPY', rate: 0.50, target: 0.75, bias: 'voorzichtig verkrappend', bank: 'Bank of Japan (BoJ)' },
  { snapshot_date: '2025-06-01', currency: 'CHF', rate: 0.00, target: 0.00, bias: 'afwachtend', bank: 'SNB' },
  { snapshot_date: '2025-06-01', currency: 'AUD', rate: 3.85, target: 3.60, bias: 'afwachtend', bank: 'RBA' },
  { snapshot_date: '2025-06-01', currency: 'CAD', rate: 2.50, target: 2.25, bias: 'voorzichtig verruimend', bank: 'BoC' },
  { snapshot_date: '2025-06-01', currency: 'NZD', rate: 3.25, target: 3.00, bias: 'afwachtend', bank: 'RBNZ' },
  // ═══ 2025-07 ═══ Fed cut to 3.83, BoE cut to 4.00%
  { snapshot_date: '2025-07-01', currency: 'USD', rate: 3.83, target: 3.58, bias: 'voorzichtig verruimend', bank: 'Federal Reserve (Fed)' },
  { snapshot_date: '2025-07-01', currency: 'EUR', rate: 2.25, target: 2.00, bias: 'afwachtend', bank: 'ECB' },
  { snapshot_date: '2025-07-01', currency: 'GBP', rate: 4.00, target: 3.75, bias: 'voorzichtig verruimend', bank: 'Bank of England (BoE)' },
  { snapshot_date: '2025-07-01', currency: 'JPY', rate: 0.75, target: 1.00, bias: 'voorzichtig verkrappend', bank: 'Bank of Japan (BoJ)' },
  ...
  { snapshot_date: '2025-07-01', currency: 'NZD', rate: 3.00, target: 2.75, bias: 'voorzichtig verruimend', bank: 'RBNZ' },
  // ═══ 2025-08 ═══ Most hold, RBNZ cut to 2.75%
  { snapshot_date: '2025-08-01', currency: 'USD', rate: 3.83, target: 3.58, bias: 'afwachtend', bank: 'Federal Reserve (Fed)' },
  { snapshot_date: '2025-08-01', currency: 'EUR', rate: 2.15, target: 1.90, bias: 'voorzichtig verruimend', bank: 'ECB' },
  { snapshot_date: '2025-08-01', currency: 'GBP', rate: 4.00, target: 3.75, bias: 'afwachtend', bank: 'Bank of England (BoE)' },
  { snapshot_date: '2025-08-01', currency: 'JPY', rate: 0.75, target: 1.00, bias: 'voorzichtig verkrappend', bank: 'Bank of Japan (BoJ)' },
  { snapshot_date: '2025-08-01', currency: 'CHF', rate: 0.00, target: 0.00, bias: 'afwachtend', bank: 'SNB' },
  { snapshot_date: '2025-08-01', currency: 'AUD', rate: 3.60, target: 3.35, bias: 'voorzichtig verruimend', bank: 'RBA' },
  { snapshot_date: '2025-08-01', currency: 'CAD', rate: 2.50, target: 2.25, bias: 'afwachtend', bank: 'BoC' },
  { snapshot_date: '2025-08-01', currency: 'NZD', rate: 2.75, target: 2.50, bias: 'voorzichtig verruimend', bank: 'RBNZ' },
  // ═══ 2025-09 ═══ Fed cut to 3.58, ECB cut to 1.90%
  { snapshot_date: '2025-09-01', currency: 'USD', rate: 3.58, target: 3.33, bias: 'voorzichtig verruimend', bank: 'Federal Reserve (Fed)' },
  { snapshot_date: '2025-09-01', currency: 'EUR', rate: 1.90, target: 1.75, bias: 'voorzichtig verruimend', bank: 'ECB' },
  { snapshot_date: '2025-09-01', currency: 'GBP', rate: 4.00, target: 3.75, bias: 'afwachtend', bank: 'Bank of England (BoE)' },
  { snapshot_date: '2025-09-01', currency: 'JPY', rate: 0.75, target: 1.00, bias: 'voorzichtig verkrappend', bank: 'Bank of Japan (BoJ)' },
  { snapshot_date: '2025-09-01', currency: 'CHF', rate: 0.00, target: 0.00, bias: 'afwachtend', bank: 'SNB' },
  { snapshot_date: '2025-09-01', currency: 'AUD', rate: 3.60, target: 3.35, bias: 'afwachtend', bank: 'RBA' },
  { snapshot_date: '2025-09-01', currency: 'CAD', rate: 2.25, target: 2.00, bias: 'voorzichtig verruimend', bank: 'BoC' },
  { snapshot_date: '2025-09-01', currency: 'NZD', rate: 2.75, target: 2.50, bias: 'afwachtend', bank: 'RBNZ' },
  // ═══ 2025-10 ═══ BoE cut to 3.75%, BoJ hike to 1.00%
  { snapshot_date: '2025-10-01', currency: 'USD', rate: 3.58, target: 3.33, bias: 'afwachtend', bank: 'Federal Reserve (Fed)' },
  { snapshot_date: '2025-10-01', currency: 'EUR', rate: 1.90, target: 1.75, bias: 'afwachtend', bank: 'ECB' },
  { snapshot_date: '2025-10-01', currency: 'GBP', rate: 3.75, target: 3.50, bias: 'voorzichtig verruimend', bank: 'Bank of England (BoE)' },
  { snapshot_date: '2025-10-01', currency: 'JPY', rate: 1.00, target: 1.25, bias: 'voorzichtig verkrappend', bank: 'Bank of Japan (BoJ)' },
  ...
  // ═══ 2025-11 ═══ Most on hold
  { snapshot_date: '2025-11-01', currency: 'USD', rate: 3.58, target: 3.33, bias: 'afwachtend', bank: 'Federal Reserve (Fed)' },
  { snapshot_date: '2025-11-01', currency: 'EUR', rate: 1.90, target: 1.75, bias: 'afwachtend', bank: 'ECB' },
  { snapshot_date: '2025-11-01', currency: 'GBP', rate: 3.75, target: 3.50, bias: 'afwachtend', bank: 'Bank of England (BoE)' },
  { snapshot_date: '2025-11-01', currency: 'JPY', rate: 1.00, target: 1.25, bias: 'voorzichtig verkrappend', bank: 'Bank of Japan (BoJ)' },
  { snapshot_date: '2025-11-01', currency: 'CHF', rate: 0.00, target: 0.00, bias: 'afwachtend', bank: 'SNB' },
  { snapshot_date: '2025-11-01', currency: 'AUD', rate: 3.60, target: 3.35, bias: 'afwachtend', bank: 'RBA' },
  { snapshot_date: '2025-11-01', currency: 'CAD', rate: 2.25, target: 2.00, bias: 'afwachtend', bank: 'BoC' },
  { snapshot_date: '2025-11-01', currency: 'NZD', rate: 2.75, target: 2.50, bias: 'afwachtend', bank: 'RBNZ' },
  // ═══ 2025-12 ═══ Fed cut to 3.33, ECB cut to 1.75%
  { snapshot_date: '2025-12-01', currency: 'USD', rate: 3.33, target: 3.08, bias: 'voorzichtig verruimend', bank: 'Federal Reserve (Fed)' },
  { snapshot_date: '2025-12-01', currency: 'EUR', rate: 1.90, target: 1.75, bias: 'afwachtend', bank: 'ECB' },
  { snapshot_date: '2025-12-01', currency: 'GBP', rate: 3.75, target: 3.50, bias: 'afwachtend', bank: 'Bank of England (BoE)' },
  { snapshot_date: '2025-12-01', currency: 'JPY', rate: 1.00, target: 1.25, bias: 'voorzichtig verkrappend', bank: 'Bank of Japan (BoJ)' },
  { snapshot_date: '2025-12-01', currency: 'CHF', rate: 0.00, target: 0.00, bias: 'afwachtend', bank: 'SNB' },
  { snapshot_date: '2025-12-01', currency: 'AUD', rate: 3.60, target: 3.35, bias: 'afwachtend', bank: 'RBA' },
  { snapshot_date: '2025-12-01', currency: 'CAD', rate: 2.25, target: 2.00, bias: 'afwachtend', bank: 'BoC' },
  { snapshot_date: '2025-12-01', currency: 'NZD', rate: 2.75, target: 2.50, bias: 'afwachtend', bank: 'RBNZ' },
  // ═══ 2026-01 ═══ Fed cut to 3.75 (25bp), ECB cut to 1.90%, BoJ hike considered
  { snapshot_date: '2026-01-01', currency: 'USD', rate: 3.75, target: 3.50, bias: 'afwachtend', bank: 'Federal Reserve (Fed)' },
  { snapshot_date: '2026-01-01', currency: 'EUR', rate: 1.90, target: 1.75, bias: 'afwachtend', bank: 'ECB' },
  { snapshot_date: '2026-01-01', currency: 'GBP', rate: 3.75, target: 3.50, bias: 'voorzichtig verruimend', bank: 'Bank of England (BoE)' },
  { snapshot_date: '2026-01-01', currency: 'JPY', rate: 1.00, target: 1.25, bias: 'voorzichtig verkrappend', bank: 'Bank of Japan (BoJ)' },
  { snapshot_date: '2026-01-01', currency: 'CHF', rate: 0.00, target: 0.00, bias: 'afwachtend', bank: 'SNB' },
  { snapshot_date: '2026-01-01', currency: 'AUD', rate: 4.10, target: 3.85, bias: 'voorzichtig verruimend', bank: 'RBA' },
  ...
  // ═══ 2026-02 ═══ RBA cut to 3.85% (Feb 18), BoE cut to 3.75% (Feb)
  { snapshot_date: '2026-02-01', currency: 'USD', rate: 3.75, target: 3.50, bias: 'afwachtend', bank: 'Federal Reserve (Fed)' },
  { snapshot_date: '2026-02-01', currency: 'EUR', rate: 1.90, target: 1.75, bias: 'afwachtend', bank: 'ECB' },
  { snapshot_date: '2026-02-01', currency: 'GBP', rate: 3.75, target: 3.50, bias: 'voorzichtig verruimend', bank: 'Bank of England (BoE)' },
  { snapshot_date: '2026-02-01', currency: 'JPY', rate: 1.00, target: 1.25, bias: 'voorzichtig verkrappend', bank: 'Bank of Japan (BoJ)' },
  { snapshot_date: '2026-02-01', currency: 'CHF', rate: 0.00, target: 0.00, bias: 'afwachtend', bank: 'SNB' },
  { snapshot_date: '2026-02-01', currency: 'AUD', rate: 3.85, target: 3.60, bias: 'voorzichtig verruimend', bank: 'RBA' },
  { snapshot_date: '2026-02-01', currency: 'CAD', rate: 2.25, target: 2.00, bias: 'afwachtend', bank: 'BoC' },
  { snapshot_date: '2026-02-01', currency: 'NZD', rate: 2.75, target: 2.50, bias: 'afwachtend', bank: 'RBNZ' },
  // ═══ 2026-03 ═══ RBA held at 3.85% (Mar 31)
  { snapshot_date: '2026-03-01', currency: 'USD', rate: 3.75, target: 3.50, bias: 'afwachtend', bank: 'Federal Reserve (Fed)' },
  { snapshot_date: '2026-03-01', currency: 'EUR', rate: 1.90, target: 1.75, bias: 'afwachtend', bank: 'ECB' },
  { snapshot_date: '2026-03-01', currency: 'GBP', rate: 3.75, target: 3.50, bias: 'voorzichtig verruimend', bank: 'Bank of England (BoE)' },
  { snapshot_date: '2026-03-01', currency: 'JPY', rate: 1.00, target: 1.25, bias: 'voorzichtig verkrappend', bank: 'Bank of Japan (BoJ)' },
  { snapshot_date: '2026-03-01', currency: 'CHF', rate: 0.00, target: 0.00, bias: 'afwachtend', bank: 'SNB' },
  { snapshot_date: '2026-03-01', currency: 'AUD', rate: 3.85, target: 3.60, bias: 'afwachtend', bank: 'RBA' },
  { snapshot_date: '2026-03-01', currency: 'CAD', rate: 2.25, target: 2.00, bias: 'afwachtend', bank: 'BoC' },
  { snapshot_date: '2026-03-01', currency: 'NZD', rate: 2.75, target: 2.50, bias: 'afwachtend', bank: 'RBNZ' },
  // ═══ 2026-04 ═══ Current month — rates as of April 2026
  { snapshot_date: '2026-04-01', currency: 'USD', rate: 3.75, target: 3.50, bias: 'afwachtend', bank: 'Federal Reserve (Fed)' },
  { snapshot_date: '2026-04-01', currency: 'EUR', rate: 1.90, target: 1.75, bias: 'afwachtend', bank: 'ECB' },
  { snapshot_date: '2026-04-01', currency: 'GBP', rate: 3.75, target: 3.50, bias: 'voorzichtig verruimend', bank: 'Bank of England (BoE)' },
  { snapshot_date: '2026-04-01', currency: 'JPY', rate: 1.00, target: 1.25, bias: 'voorzichtig verkrappend', bank: 'Bank of Japan (BoJ)' },
