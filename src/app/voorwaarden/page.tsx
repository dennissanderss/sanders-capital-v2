  ...
  return (
    <div>
      ...
      <div className="border-b border-border bg-bg-elevated">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 pt-16 pb-12 sm:pt-20 sm:pb-14">
          <FadeIn>
            <nav className="flex items-center gap-2 font-mono text-[11.5px] tracking-wide text-text-dim">
            ...
            <span className="mt-5 inline-flex items-center gap-2.5 text-xs font-semibold uppercase tracking-[0.18em] text-accent before:h-px before:w-6 before:bg-accent before:opacity-70">
              Juridisch
            </span>
            ...
            <p className="mt-4 text-base sm:text-lg text-text-muted leading-relaxed max-w-[60ch]">
              Laatst bijgewerkt: 26 maart 2026. Door gebruik te maken van Sanders Capital
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <FadeIn delay={100}>
            <div className="space-y-10 text-text leading-relaxed text-sm sm:text-base">

              {/* Artikel 1 */}
              <section>
                <h2 className="text-xl sm:text-2xl font-display font-semibold text-heading mb-3">
                  Artikel 1: Definities
                </h2>
                <div className="space-y-2">
                  <p className="text-text-muted">In deze algemene voorwaarden wordt verstaan onder:</p>
                  <ul className="space-y-1.5 pl-5 list-disc marker:text-accent text-text-muted">
              ...
              <section>
                ...
                <div className="space-y-2 text-text-muted">
                  ...
                  <ul className="space-y-1 pl-5 list-disc marker:text-accent">
