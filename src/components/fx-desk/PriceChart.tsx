...
function PriceChartSvg({
  ...
  const C = { gold: '#c8a96a', win: '#7e9b6f', loss: '#b9725f', neutral: '#8f887b' }
    ...
    <svg className="chart-svg" viewBox={`0 0 ${W} ${H}`} preserveAspectRatio="xMidYMid meet" role="img" aria-label="Koersverloop met niveaus">
      <defs>
        ...
        <linearGradient id="fxd-holdfill" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#c8a96a" stopOpacity="0.09" />
          <stop offset="100%" stopColor="#c8a96a" stopOpacity="0.015" />
        </linearGradient>
      </defs>
      ...
      <path d={line} fill="none" stroke="#c8a96a" strokeWidth="1.6" strokeLinejoin="round" />

      <circle cx={eX} cy={y(entry)} r="5.5" fill="#14110f" stroke={C.gold} strokeWidth="1.6" />
      ...
      {!open && hitV !== null && (() => {
        ...
        return (
          <g>
            ...
            <circle cx={cX} cy={my} r="6" fill="#14110f" stroke={hitC} strokeWidth="1.9" />
      ...
      {open && (
        <g>
          <circle cx={x(n - 1)} cy={y(series[n - 1])} r="5" fill="#14110f" stroke={C.neutral} strokeWidth="1.6" />
