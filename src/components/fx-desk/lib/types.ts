...
export interface ApiV3PairSignal {
  ...
  reasons: string[]
  priceMomentum: { direction: string; pips1d: number; pips5d: number; atr20d: number; extensionRatio: number; price5dAgo?: number | null; priceNow?: number | null; date5dAgo?: string | null; dateNow?: string | null }
}
